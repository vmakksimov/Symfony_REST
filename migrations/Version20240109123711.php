 ...
 */
final class Version20240109123711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT NOT NULL, product_id INT NOT NULL, url TEXT NOT NULL, price TEXT NOT NULL, price_currency TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_29D6873E4584665A ON offer (product_id)');
        $this->addSql('CREATE TABLE product (id INT NOT NULL, name TEXT NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
